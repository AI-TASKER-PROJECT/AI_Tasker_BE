...
| 20 | POST | `/api/v1/profiles/approve/{type}/{id}` | profile-controller | Cần Bearer JWT; STAFF/ADMIN | Không có body; dùng query `status=Approved` hoặc `status=Rejected&reason=...` | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
...
| 24 | POST | `/api/v1/profiles/expert/portfolio-file` | profile-controller | Cần Bearer JWT; EXPERT | form-data key `file` | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 25 | POST | `/api/v1/profiles/portfolio` | profile-controller | Cần Bearer JWT; User đã đăng nhập phù hợp quyền | Có JSON body theo schema Swagger | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 26 | POST | `/api/v1/profiles/portfolio/certificate-file` | profile-controller | Cần Bearer JWT; User đã đăng nhập phù hợp quyền | form-data key `file` | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |

### Catalog job metadata

| STT | Method | API | Swagger tag | Token/Role | Body khi test | Kết quả cần kiểm tra |
| --- | --- | --- | --- | --- | --- | --- |
| 27 | GET | `/api/v1/acceptance-criteria` | catalog-controller | Không cần token; Public | Không có body | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 28 | GET | `/api/v1/domains` | catalog-controller | Không cần token; Public | Không có body | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 29 | GET | `/api/v1/jobs/{jobId}/domains` | catalog-controller | Cần Bearer JWT; User đã đăng nhập phù hợp quyền | Không có body | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 30 | GET | `/api/v1/jobs/{jobId}/skills` | catalog-controller | Cần Bearer JWT; User đã đăng nhập phù hợp quyền | Không có body | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 31 | GET | `/api/v1/jobs/{jobId}/technologies` | catalog-controller | Cần Bearer JWT; User đã đăng nhập phù hợp quyền | Không có body | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 32 | GET | `/api/v1/skills` | catalog-controller | Không cần token; Public | Không có body | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 33 | GET | `/api/v1/technologies` | catalog-controller | Cần Bearer JWT; User đã đăng nhập phù hợp quyền | Không có body | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 34 | POST | `/api/v1/domains` | catalog-controller | Cần Bearer JWT; User đã đăng nhập phù hợp quyền | Có JSON body theo schema Swagger | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 35 | POST | `/api/v1/skills` | catalog-controller | Cần Bearer JWT; User đã đăng nhập phù hợp quyền | Có JSON body theo schema Swagger | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 36 | POST | `/api/v1/technologies` | catalog-controller | Cần Bearer JWT; User đã đăng nhập phù hợp quyền | Có JSON body theo schema Swagger | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 37 | PUT | `/api/v1/jobs/{jobId}/domains` | catalog-controller | Cần Bearer JWT; BUSINESS | Có JSON body theo schema Swagger | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 38 | PUT | `/api/v1/jobs/{jobId}/skills` | catalog-controller | Cần Bearer JWT; BUSINESS | Có JSON body theo schema Swagger | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 39 | PUT | `/api/v1/jobs/{jobId}/technologies` | catalog-controller | Cần Bearer JWT; BUSINESS | Có JSON body theo schema Swagger | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 40 | PATCH | `/api/v1/domains/{domainId}` | catalog-controller | Cần Bearer JWT; User đã đăng nhập phù hợp quyền | Có JSON body theo schema Swagger | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 41 | PATCH | `/api/v1/skills/{skillId}` | catalog-controller | Cần Bearer JWT; User đã đăng nhập phù hợp quyền | Có JSON body theo schema Swagger | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 42 | PATCH | `/api/v1/technologies/{technologyId}` | catalog-controller | Cần Bearer JWT; User đã đăng nhập phù hợp quyền | Có JSON body theo schema Swagger | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |

### Marketplace job và proposal

| STT | Method | API | Swagger tag | Token/Role | Body khi test | Kết quả cần kiểm tra |
| --- | --- | --- | --- | --- | --- | --- |
| 43 | GET | `/api/v1/jobs/{jobId}/milestones` | contract-execution-controller | Không cần token nếu job `OPEN`; cần Bearer JWT nếu job chưa public | Không có body | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 44 | GET | `/api/v1/jobs` | marketplace-controller | Không cần token; Public | Không có body | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 45 | GET | `/api/v1/jobs/my` | marketplace-controller | Không cần token; Public | Không có body | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 46 | GET | `/api/v1/jobs/{jobId}` | marketplace-controller | Không cần token; Public | Không có body | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 47 | GET | `/api/v1/jobs/{jobId}/proposals` | marketplace-controller | Cần Bearer JWT; User đã đăng nhập phù hợp quyền | Không có body | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 48 | GET | `/api/v1/proposals/my` | marketplace-controller | Cần Bearer JWT; User đã đăng nhập phù hợp quyền | Không có body | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 49 | POST | `/api/v1/jobs` | marketplace-controller | Cần Bearer JWT; BUSINESS | Có body mẫu bên dưới | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 50 | POST | `/api/v1/jobs/{jobId}/publish` | marketplace-controller | Cần Bearer JWT; BUSINESS | Không có body | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 51 | POST | `/api/v1/proposals` | marketplace-controller | Cần Bearer JWT; EXPERT | Có body mẫu bên dưới | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 52 | POST | `/api/v1/proposals/file` | marketplace-controller | Cần Bearer JWT; EXPERT | form-data key `file` | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 53 | PATCH | `/api/v1/jobs/{jobId}/status` | marketplace-controller | Cần Bearer JWT; BUSINESS | Không có body | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 54 | PATCH | `/api/v1/proposals/{proposalId}/status` | marketplace-controller | Cần Bearer JWT; User đã đăng nhập phù hợp quyền | Không có body | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
...
| STT | Method | API | Swagger tag | Token/Role | Body khi test | Kết quả cần kiểm tra |
| --- | --- | --- | --- | --- | --- | --- |
| 55 | POST | `/api/chatbot/ask` | chatbot-controller | Không cần token; Public | Có JSON body theo schema Swagger | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
| 56 | GET | `/api/v1/jobs/{jobId}/matching` | contract-execution-controller | Cần Bearer JWT; User đã đăng nhập phù hợp quyền | Không có body | HTTP 2xx hoặc lỗi nghiệp vụ rõ ràng; kiểm tra `success`, `message`, `data`. |
