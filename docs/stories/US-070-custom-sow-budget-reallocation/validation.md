...
result: PASS after Week 10 merge - 200 operations and custom reallocation request/response refs present

command: route inventory counts in Swagger overview/test guide/Postman guide
result: PASS for feature route - overview has 200 rows; Swagger/Postman guides
        have 196 sections and both contain the custom reallocation endpoint
...
| Public contract | OpenAPI 200-operation schema/path assertions, 200-row overview, and route presence in Swagger/Postman guides | Pass. |
