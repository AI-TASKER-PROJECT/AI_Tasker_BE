...
public class DisputeEntity {
    ...
    public static final String RESOLUTION_SELF_RESOLVE_AGREEMENT_CONTINUE_REVISION = "SELF_RESOLVE_AGREEMENT_CONTINUE_REVISION";
    public static final String RESOLUTION_SELF_RESOLVE_AGREEMENT_ACCEPT_DELIVERABLE = "SELF_RESOLVE_AGREEMENT_ACCEPT_DELIVERABLE";
    public static final String RESOLUTION_SELF_RESOLVE_AGREEMENT_CONTINUE_NEXT_MILESTONE = "SELF_RESOLVE_AGREEMENT_CONTINUE_NEXT_MILESTONE";
